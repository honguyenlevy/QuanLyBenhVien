...
-- Tạo role 
CREATE ROLE ROLE_BENHNHAN; --(1->10000)
CREATE ROLE ROLE_NHANVIEN; --(1->650)
CREATE ROLE ROLE_YBSI; --(1->500)
CREATE ROLE ROLE_CSYT; --(1->50)
CREATE ROLE ROLE_THANHTRA; -- (501 -> 506)
CREATE ROLE ROLE_NGHIENCUU; -- (551 -> 600)
